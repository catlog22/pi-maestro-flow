...
for issue in majorIssues:
  teammate({ agent: "delegate", taskType: "analysis", task: "PURPOSE: Simulate multi-perspective discussion on reviewer comment to develop robust response strategy\n\nPERSPECTIVES:\…", prompt: "analysis-review-architecture", /* --to agy: set model via model-availability */ })
```
