...
- **Codebase search** — prefer `teammate({ agent: "explorer", task: "FIND: <analysis target> SCOPE: src/ EXPECTED: file:line evidence", taskType: "explore" })` over raw Grep for gathering multi-file evidence across dimensions
