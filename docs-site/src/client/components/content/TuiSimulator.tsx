...
const PRESETS: Record<string, SimPreset> = {
  ...
  cockpit: {
    ...
    items: [
      ...
      { key: 'toolPalette', label: '工具调色板', editor: 'enum', value: 'family', options: ['classic', 'family', 'readwrite', 'search', 'mono'] },
      ...
      { key: 'sidebar.mode', label: '侧栏模式', editor: 'enum', value: 'off', options: ['auto', 'on', 'off'] },
  ...
  api: {
    ...
    items: [
      ...
      { key: 'maestro-anthropic', label: 'Anthropic', editor: 'string', value: 'modelId · context', badge: { text: '启用', tone: 'green' } },
      ...
      { key: 'retry.maxRetries', label: '最大重试次数', editor: 'integer', value: 5, min: 0, max: 10 },
