...
- **Codebase search** — prefer `teammate({ agent: "explorer", taskType: "explore", tasks: [{ prompt: "FIND: <pattern> SCOPE: src/ EXCLUDE: tests" }] })` over raw Grep when searching for implementation patterns or integration points
