...
- **Codebase search** — prefer `teammate({ agent: "explorer", tasks: [{ prompt: "FIND: <symptom> SCOPE: src/ ATTENTION: <error context>" }] })` over raw Grep for multi-file evidence gathering
