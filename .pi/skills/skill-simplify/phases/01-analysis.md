...
- **Agent calls**: Match `teammate(`, `Task(`, `subagent_type=`, record type and prompt summary
...
- If block contains ANY of: `teammate(`, `Bash(`, `AskUserQuestion(`, `if (`, `switch`, `Skill(`, `Write(`, `Read(`, `todo({ action: "update" })(` → `functional`
...
| "Next Phase" paragraphs | Prose between phases when todo({ action: "update" }) handles flow |
