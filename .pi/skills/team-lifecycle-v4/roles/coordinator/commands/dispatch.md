...
5. For each task (in order):
   ...
   - todo({ action: "update" }) with blockedBy + owner assignment
...
RoleSpec: ~  or <project>/.pi/skills/team-lifecycle-v4/roles/<role>/role.md
```
...
- Created via todo({ action: "create" }) with proper blockedBy (upstream tasks that must complete first)
- Owner: supervisor
...
- RoleSpec in description: `~  or <project>/.pi/skills/team-lifecycle-v4/roles/supervisor/role.md`
