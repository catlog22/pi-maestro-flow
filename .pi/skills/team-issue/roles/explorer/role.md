...
| Medium/High | CLI exploration: `Bash("teammate({ agent: "general", taskType: "analysis", tasks: [{ prompt: "<exploration_prompt>" }], /* --to agy: set model via model-availability */ }) { background: false })` |
