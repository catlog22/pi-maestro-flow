...
|--------|------|-----------|------------|
| PLAN | planner | `~  or <project>/.pi/skills/team-roadmap-dev/roles/planner/role.md` | true |
| EXEC | executor | `~  or <project>/.pi/skills/team-roadmap-dev/roles/executor/role.md` | true |
