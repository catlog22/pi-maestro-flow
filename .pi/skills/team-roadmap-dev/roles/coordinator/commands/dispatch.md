...
```javascript
const planTaskId = todo({ action: "create" })({
...
4. todo({ action: "update" }) this task to completed when plan is written`,
...
```javascript
const execTaskId = todo({ action: "create" })({
...
5. todo({ action: "update" }) this task to completed when all plans executed`,
...
```javascript
const verifyTaskId = todo({ action: "create" })({
...
6. todo({ action: "update" }) this task to completed with result (passed/gaps_found)`,
