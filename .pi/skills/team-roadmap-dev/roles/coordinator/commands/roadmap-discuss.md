...
Bash({
  command: `teammate({ agent: "delegate", taskType: "analysis", task: "PURPOSE: Analyze codebase and generate phased execution roadmap for: ${projectGoal}\nTASK: \\\n  - Scan project structur…" }) \
