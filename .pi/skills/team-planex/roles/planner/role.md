...
```bash
teammate({ agent: "delegate", taskType: "analysis", task: "PURPOSE: Generate implementation solution for issue <issueId>; success = actionable task breakdown with file paths\nTASK…", prompt: "planning-breakdown-task-steps" })
```
