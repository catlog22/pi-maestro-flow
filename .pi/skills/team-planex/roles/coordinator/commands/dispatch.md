...
3. After each solution: create EXEC-* task with solution_file path, then todo({ action: "update" }) to set owner: executor
...
| Check | Criteria |
|-------|----------|
| PLAN-001 created | todo({ action: "list" }) shows PLAN-001 |
