export declare const RUNTIME_V2_VERSION: 2;
export declare const RUNTIME_V2_REVISION: 1;
...
export type RuntimeEventV2 = RuntimeToolStartedEventV2 | RuntimeToolFinishedEventV2 | RuntimeResultPublishedEventV2 | RuntimeRunSettledEventV2 | RuntimeProcessReclaimedEventV2 | RuntimeDomainEventV2;
export type RuntimeEventDraftV2 = RuntimeEventV2 extends infer Event ? Event extends RuntimeEventV2 ? Omit<Event, "sequence" | "producerEpoch"> : never : never;
