 ...
 */
export type TranscriptRowKind = "user" | "assistant" | "tool" | "tool_result" | "thinking" | "system" | "meta";
...
export declare const TEAMMATE_SESSION_CUSTOM_TYPE = "pi-teammate-session";
