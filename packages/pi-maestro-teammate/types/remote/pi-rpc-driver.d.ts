...
export declare const PI_RPC_CAPABILITIES: readonly ("steer" | "usage" | "cancel" | "streaming" | "follow-up" | "tool-events" | "structured-output" | "session-resume")[];
...
export declare class PiRpcDriver implements RemoteDriver {
    #private;
    readonly id: "pi-rpc";
    readonly capabilities: readonly ("steer" | "usage" | "cancel" | "streaming" | "follow-up" | "tool-events" | "structured-output" | "session-resume")[];
