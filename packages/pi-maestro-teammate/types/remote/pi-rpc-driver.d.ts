...
export declare const PI_RPC_CAPABILITIES: readonly ("steer" | "usage" | "streaming" | "follow-up" | "cancel" | "tool-events" | "structured-output" | "session-resume")[];
...
export declare class PiRpcDriver implements RemoteDriver {
    #private;
    readonly id: "pi-rpc";
    readonly capabilities: readonly ("steer" | "usage" | "streaming" | "follow-up" | "cancel" | "tool-events" | "structured-output" | "session-resume")[];
