...
export declare const SUPERVISION_EVENT = "supervision:event";
export declare function createSupervisionEvent(source: SupervisionSource, kind: SupervisionKind, severity: SupervisionSeverity, overrides?: Omit<SupervisionEvent, "source" | "kind" | "severity" | "timestamp">): SupervisionEvent;
