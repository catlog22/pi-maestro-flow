...
export declare const WORKSPACE_PEER_PLUGIN_ID: "pi-maestro-teammate";
export declare const WORKSPACE_PEER_COMMAND_PROTOCOL_VERSION: 1;
export declare const WORKSPACE_PEER_RELAY_CAPABILITIES: readonly ["receipt", "reply"];
...
export declare function validateWorkspaceOwnerPluginAdvertisement(value: unknown): WorkspaceOwnerPluginAdvertisement | undefined;
export declare function validateWorkspaceOwnerProtocolAdvertisement(value: unknown): WorkspaceOwnerProtocolAdvertisement | undefined;
export declare function validateWorkspaceOwnerRelayAdvertisement(value: unknown): WorkspaceOwnerRelayAdvertisement | undefined;
/**
...
export declare function readWorkspacePeerResponseForOwner(identity: WorkspacePeerIdentity, ownerId: string, commandId: string): Promise<WorkspacePeerCommandResponse | undefined>;
/**
