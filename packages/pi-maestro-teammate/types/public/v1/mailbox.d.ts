 ...
 */
export declare function createMailboxHostRegistry(service: import("../../extension/mailbox/service.ts").MailboxService, localCapability?: MailboxCapability): MailboxHostRegistry;
