...
export type ExpertsTaskType = "explore" | "analysis" | "debug" | "development" | "review" | "planning" | "testing" | "verification";
...
export interface ExpertsRules {
     ...
     */
    roster?: Record<string, Omit<RosterEntry, "id"> & {
        id?: string;
    }>;
    /**
     ...
     */
    expertProfiles?: Record<string, Omit<RosterEntry, "id"> & {
        id?: string;
    }>;
    /**
