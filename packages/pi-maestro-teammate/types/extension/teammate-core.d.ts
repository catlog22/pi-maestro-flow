...
export declare const LOCAL_TEAMMATE_SEND_DESCRIPTION = "Send a message to a running or sleeping teammate agent owned by this Pi process, addressed by name, @name, displayed name#id-prefix, or correlation ID (or prefix).\n\nModes: \"steer\" interrupts the current turn, \"follow_up\" queues after it, and \"abort\" terminates the local agent subtree.";
export declare const LOCAL_TEAMMATE_SEND_SNIPPET = "Send a correction, follow-up, or termination command to a local teammate agent.";
export declare const LOCAL_TEAMMATE_SEND_GUIDELINES: string[];
