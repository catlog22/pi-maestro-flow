...
export type RuntimeBrokerErrorCode = "idempotency_conflict" | "invalid_request" | "lease_unavailable" | "revision_conflict" | "stale_lease";
...
export declare class RuntimeBrokerError extends Error {
    readonly code: RuntimeBrokerErrorCode;
    readonly details?: {
        [key: string]: JsonValue;
    };
    constructor(code: RuntimeBrokerErrorCode, message: string, details?: {
        [key: string]: JsonValue;
    });
...
export declare function assertNonNegativeInteger(value: unknown, field: string): asserts value is number;
export declare function assertPositiveInteger(value: unknown, field: string): asserts value is number;
export declare function assertJsonValue(value: unknown, field: string): asserts value is JsonValue;
