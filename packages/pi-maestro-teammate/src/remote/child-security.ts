...
const SECRET_ENV_NAME = /(?:^|_)(?:API_?KEY|ACCESS_?KEY(?:_?ID)?|ACCESS_?TOKEN|AUTH|BEARER|CREDENTIAL|PASSWORD|PASSWD|PRIVATE_?KEY|SECRET|TOKEN)(?:_|$)/i;
...
export function targetChildEnvironment(
  ...
  return sanitizedChildEnvironment({ additions: merged, allowSecretAdditions: true });
}
